...
public class GamePanel extends JPanel {
    ...
    public GamePanel(FlappyBird fb, Bird bird, ArrayList<Rectangle> rects) {
        ...
        try {
            pipeHead = ImageIO.read(new File("C:/Users/SHREYANS/Pictures/java project/78px-Pipe.png"));
            pipeLength = ImageIO.read(new File("C:/Users/SHREYANS/Pictures/java project/pipe_part.png"));
        }
        catch(IOException e) {
            e.printStackTrace();
        }
